...
if (isset($_POST['localidad'])) {
    $localidad = mysqli_real_escape_string(mysql: $conex, string: $_POST['localidad']);
    
    $consulta = "SELECT COUNT(localidad) AS total_incidentes FROM incidentes WHERE localidad='$localidad';";
